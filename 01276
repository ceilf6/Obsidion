...
https://github.com/ceilf6/Lab/commit/61e72525b420ba782a1ba1869b6b4aa4de1f1502

模板模式的定义：

> 模板模式是一种行为设计模式，这种模式会在超类中去定义一个算法的**框架**（**步骤**），然后子类会在不修改结构的情况下**重写算法的特定步骤**。
> 

整个模板模式，是由两个部分组成的：

- **抽象的父类**：封装子类的算法框架，包括实现一些公共的方法以及子类中所有方法的执行顺序。
- 各个**子类**：会继承这个抽象类，也就继承了整个算法的结构，子类会针对这个结构里面的部分算法进行一个重写。
...
![image.png](%E6%A8%A1%E6%9D%BF%E6%A8%A1%E5%BC%8F/image.png)
...
![image.png](%E6%A8%A1%E6%9D%BF%E6%A8%A1%E5%BC%8F/image%201.png)
