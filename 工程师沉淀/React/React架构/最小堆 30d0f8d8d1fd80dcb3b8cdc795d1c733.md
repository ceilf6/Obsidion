...
![image.png](工程师沉淀/React/React架构/最小堆/image.png)
...
![image.png](工程师沉淀/React/React架构/最小堆/image%201.png)
...
![image.png](工程师沉淀/React/React架构/最小堆/image%202.png)

最小堆示例：

![image.png](工程师沉淀/React/React架构/最小堆/image%203.png)

- 无论是最大堆还是最小堆，第一个节点一定是这个堆中最大的或者最小的
- 每一层并非是按照一定顺序来排列的，比如下面的例子，6可以在左分支，3可以在右分支

![image.png](工程师沉淀/React/React架构/最小堆/image%204.png)
...
![image.png](工程师沉淀/React/React架构/最小堆/image%205.png)
...
![image.png](工程师沉淀/React/React架构/最小堆/image%206.png)
...
![image.png](工程师沉淀/React/React架构/最小堆/image%207.png)