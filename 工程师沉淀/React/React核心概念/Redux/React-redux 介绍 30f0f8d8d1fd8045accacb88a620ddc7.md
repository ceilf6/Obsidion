...
- *state* 是**只读的**，每次状态更新之后只能返回一个新的 *state*
- 没有 *Dispatcher* ，而是**在 *Store* 中集成了 *dispatch* 方法**，**`store.dispatch()` 是 *View* 发出 *Action* 的唯一途径**
...
<img src="[https://xiejie-typora.oss-cn-chengdu.aliyuncs.com/2022-11-04-030252.png](https://xiejie-typora.oss-cn-chengdu.aliyuncs.com/2022-11-04-030252.png)" alt="image-20221104110251637" style="zoom:50%;" />

*Redux* 示例：*ToDoList*

在浏览器中使用 *redux* 扩展工具，首先需要打开谷歌浏览器的扩展应用商店，下载 *redux devtools*

<img src="[https://xiejie-typora.oss-cn-chengdu.aliyuncs.com/2022-11-07-062826.png](https://xiejie-typora.oss-cn-chengdu.aliyuncs.com/2022-11-07-062826.png)" alt="image-20221107142826791" style="zoom:50%;" />
