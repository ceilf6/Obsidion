...
npm全命令：[https://docs.npmjs.com/cli/v7/commands](https://docs.npmjs.com/cli/v7/commands)
...
1. 查找是否有**内置模块**a
2. 查找**当前目录的node_modules**中是否有a
3. 依次查找**上级目录的node_modules**中是否有a，直到根目录
...
会将包**下载到当前命令行所在目录的node_modules**中
...
若**仅作为开发依赖，则添加参数`-D`**  或者是 save-dev
