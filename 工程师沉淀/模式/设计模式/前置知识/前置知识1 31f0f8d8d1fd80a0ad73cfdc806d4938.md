...
![image.png](工程师沉淀/模式/设计模式/前置知识/前置知识1/image.png)

所谓对象，就是根据类来创建的具体的实例，所以我们一般称之为实例对象。一个实例对象会拥有类中所定义的属性和方法。

![image.png](工程师沉淀/模式/设计模式/前置知识/前置知识1/image%201.png)
...
![image.png](工程师沉淀/模式/设计模式/前置知识/前置知识1/image%202.png)
...
![image.png](工程师沉淀/模式/设计模式/前置知识/前置知识1/image%203.png)
