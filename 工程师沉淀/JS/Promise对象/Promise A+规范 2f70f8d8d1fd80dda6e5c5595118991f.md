...
1. 所有的异步场景，都可以看作是一个**异步任务**，每个异步任务，在JS中应该表现为一个**对象**，该对象称之为**Promise对象**，也叫做**任务对象**
    ...
    [Promise本质是一个未来才能得到的值的占位符](并发执行%203170f8d8d1fd80d7897bf7e784c35325.md) 
    
    ![image.png](工程师沉淀/JS/Promise对象/Promise%20A+规范/image.png)
    
2. 每个任务对象，都应该有两个阶段、三个状态
    
    ![image.png](工程师沉淀/JS/Promise对象/Promise%20A+规范/image%201.png)
