...
[](执行上下文%20-%20词法环境%20作用域链%20闭包%203120f8d8d1fd8022b3eaee14fa65b4b3.md) 
...
[**原型上不要挂载箭头函数**](原型和原型链%202fc0f8d8d1fd803086aee8191211fffa.md) 
...
4. 没有**`this`**
    ...
    [    **箭头**函数的 this 不是调用时绑定、而是**词法绑定的**，其指向不看运行时调用方式，而看其**定义位置的外层**](this%20指向%203000f8d8d1fd80789f87f53f74e74a58.md) 
...
![image.png](工程师沉淀/JS/ES6/改动/image.png)
