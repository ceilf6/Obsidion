...
https://github.com/ceilf6/Lab/commit/623b5b9a6d17c4e413af8fd240ac1e55ed64db61
...
- 需要使用**ajax获得某个数据之后才能加载**该组件（即配置对象依赖AJAX数据）
- 为了合理的**分包**，组件配置对象需要通过`import(xxx)`动态加载
...
> 异步组件的函数不仅可以**返回一个Promise**，还支持**返回一个对象**
> 
> 
