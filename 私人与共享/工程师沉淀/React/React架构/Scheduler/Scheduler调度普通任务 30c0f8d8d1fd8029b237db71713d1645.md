...
https://github.com/ceilf6/Lab/commit/3ea90c87be8994a9564655d8ba7af649d2e826de
...
https://github.com/ceilf6/Lab/commit/4ca4d64af37ef08b51965a90f4461163fe575b6a

该函数的主要目的就是用**调度任务**，该方法的分析如下：
...
- 关于任务队列有两个，一个 taskQueue，另一个是 timerQueue，**taskQueue** 存放**普通**任务，**timerQueue** 存放**延时**任务，任务队列内部用到了**小顶堆**的算法，保证始终放进去（push）的任务能够进行正常的排序，回头通过 peek 取出任务时，始终取出的是时间**优先级**最高的那个任务
...
https://github.com/ceilf6/react/compare/2846ce7d3a0c6079b12c08e64e2de320cdd498b4...3eb97ce20f6876d27e0149a49db44ef51a60ef3c#diff-81303f171a39f58daae0272fbafaf677ef7589e54a5f5c5e891c7c40ff9fc6be

早期的 requestHostCallback 是需要传入一个参数 callback 的
...
https://github.com/ceilf6/react/compare/24056e335fd46893bb9a036d684544a4b2f685ef...90860f68941b548299e93a70f4f9eb6a189d80ff#diff-81303f171a39f58daae0272fbafaf677ef7589e54a5f5c5e891c7c40ff9fc6be
...
根据 taskQueue => timerQueue 返回布尔值给 hasMoreWork
...
https://github.com/ceilf6/react/compare/4eb39b93d9e6b75f32ad777b694d41b24a68af27...954b552d5e358bccf6b1049b3acc724aa4d167d9#diff-81303f171a39f58daae0272fbafaf677ef7589e54a5f5c5e891c7c40ff9fc6be
