...
<img src="[https://xiejie-typora.oss-cn-chengdu.aliyuncs.com/2024-05-07-090308.png](https://xiejie-typora.oss-cn-chengdu.aliyuncs.com/2024-05-07-090308.png)" alt="image-20240507170307699" style="zoom:50%;" />
...
- 无论是 **普通对象** 还是 **构造器对象**，都会有自己的原型对象，通过 \**proto** 这个隐式属性，就能找到自己的原型对象，并且**一直向上找，最终会到达 null.**
...
<img src="[https://xiejie-typora.oss-cn-chengdu.aliyuncs.com/2022-08-24-072905.png](https://xiejie-typora.oss-cn-chengdu.aliyuncs.com/2022-08-24-072905.png)" alt="image-20220824152905132" style="zoom: 45%;" />

你现在也就能够理解，为什么所有的构造函数内置方法都是挂在原型对象上面的。

例如：[https://developer.mozilla.org/zh-CN/docs/Web/JavaScript/Reference/Global_Objects/Array](https://developer.mozilla.org/zh-CN/docs/Web/JavaScript/Reference/Global_Objects/Array)
