...
Promise是一套专门处理异步场景的规范，它能有效的**避免回调地狱**的产生，使异步代码更加**清晰**、简洁、统一
...
1. 所有的异步场景，都可以看作是一个**异步任务**，每个异步任务，在JS中应该表现为一个**对象**，该对象称之为**Promise对象**，也叫做**任务对象**
    
    所以像**封装异步任务的函数基本都返回的 Promise对象**
    
    [Promise本质是一个未来才能得到的值的占位符](../../%E5%AF%BF%E5%8F%B8/%E5%B9%B6%E5%8F%91%E6%89%A7%E8%A1%8C%203170f8d8d1fd80d7897bf7e784c35325.md) 
    
    ![image.png](Promise%20A+%E8%A7%84%E8%8C%83/image.png)
    
2. 每个任务对象，都应该有两个阶段、三个状态
    
    ![image.png](Promise%20A+%E8%A7%84%E8%8C%83/image%201.png)
