...
**Less代码虽好，但它无法被浏览器识别**，因此需要一个工具**将其转换为血统纯正的css代码**

由于**node环境具有读写文件的能力**，于是在node环境中可以轻松的完成文件的转换

`npm`上有一个**包**叫做**`less`**，它运行在node环境中，通过它可以完成对Less代码的转换

![image.png](Less%20-%20CSS%E5%B7%A5%E7%A8%8B%E5%8C%96/image.png)
